"""
@wi EL-139 EL-137 main module comment
...
class MyClass:
	...
	a = 10
    # @wi EL-139 MyClass 3nd comment
	def myFunc(self):
        # @wi EL-139 myFunc DocString comment
        # asda decode
        # @wi EL-139 myFunc 2nd comment
		print('Hello')
...
# @wi EL-139 random statement comment
print(MyClass.func)
